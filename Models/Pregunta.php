...
class Pregunta { 
    ...
    public function setFechaPregunta($fecha_pregunta) {
        //if ($fecha_pregunta === null || date_format(date_create_from_format('Y-m-d', $fecha_pregunta), 'Y-m-d') !== $fecha_pregunta) {
    ...
    public function setFechaRespuesta($fecha_respuesta) {
        /*
        if ($fecha_respuesta !== null && date_format(date_create_from_format('Y-m-d', $fecha_respuesta), 'Y-m-d') !== $fecha_respuesta) {
